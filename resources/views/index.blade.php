        ...
        <div class="col-md-6 mb-5">
          <div class="card shadow border-0 h-100">
            <div class="card-body">
              ...
              <a href="{{route("login")}}" class="btn btn-outline-primary btn-lg mt-3 w-100">Masuk sebagai Admin</a>
            </div>
          </div>
        </div>
        <div class="col-md-6 mb-5">
          <div class="card shadow border-0 h-100">
            <div class="card-body">
              ...
              <a href="{{route("room.index")}}" class="btn btn-success btn-lg mt-3 w-100">Masuk sebagai Siswa</a>
            </div>
          </div>
        </div>
      </div>
